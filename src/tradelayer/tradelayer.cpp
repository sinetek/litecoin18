		...
		unsigned int minInputs)
{
	...
	// If this request is only to create,
	// but not to commit the transaction,
	...
	/**
	 * Otherwise commit the transaction and broadcast.
	 */
	 ...
	 *
	 *  CTransactionRef, mapValue_t, vector<pair>,
	 *  ReserveKey, CConnman, CValidationState;
	 *
	 */
